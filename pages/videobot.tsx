...
const Videobot = () => {
  ...
  const [apiMsg, setpiMsg] = useState('');
  ...
  async function handleVideo(responseurl: any) {
    const responseVideo = await fetch(
      'http://solutions.it-marketing.website:4200/get-video',
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
